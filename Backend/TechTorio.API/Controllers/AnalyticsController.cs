...
using TechTorio.Application.Features.Analytics.Commands.TrackPageView;
using TechTorio.Application.Features.Analytics.Queries.GetAnalytics;
using TechTorio.Application.Features.Analytics.Queries.GetSellerProductViews;
using TechTorio.Application.Features.Analytics.Queries.GetSellerSummary;
using TechTorio.Application.Features.Analytics.Queries.GetAdminSummary;
...
public class AnalyticsController : ControllerBase
{
    ...
    {
        var query = new TechTorio.Application.Features.Analytics.Queries.GetVisitorStats.GetVisitorStatsQuery
        {
            Page = page,
            PageSize = pageSize,
            StartDate = startDate,
    ...
    {
        var query = new GetAdminSummaryQuery();
        var result = await _mediator.Send(query);
        return Ok(result);
    }
}
