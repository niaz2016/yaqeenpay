      ...
      {products.length === 0 ? (
        ...
        <>
          ...
          <Box sx={{ mb: 2, p: 2, border: '1px solid #ccc', borderRadius: 1, backgroundColor: '#f9f9f9' }}>
            <Typography variant="h6" sx={{ mb: 1 }}>🐛 Debug: First Product Data</Typography>
            <Typography variant="body2" component="pre" sx={{ fontSize: '12px', overflow: 'auto', maxHeight: '200px' }}>
              {JSON.stringify({
                ...
                firstProduct: products?.[0] ? {
                  ...
                  primaryImageUrl: getPrimaryImage(products[0].images || [])
                } : null
              }, null, 2)}
            </Typography>
          </Box>
