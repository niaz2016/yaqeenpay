  ...
  const handleWithdrawalRequest = async () => {
    ...
    try {
      ...
      if (isSeller) {
        ...
        // previously buyers were blocked from requesting withdrawals; they can now request using the same endpoint
      }
        ...
        <DialogContent>
          {selectedWithdrawal ? (
            <Box sx={{ mt: 1 }}>
              ...
              <Chip label={selectedWithdrawal.status} color={getStatusColor(selectedWithdrawal.status)} size="small" />
