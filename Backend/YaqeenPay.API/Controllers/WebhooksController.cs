...
namespace YaqeenPay.API.Controllers
{
    ...
    public class WebhooksController : ApiControllerBase
    {
        ...
        private readonly YaqeenPay.Application.Features.Wallets.Services.IBankSmsProcessingService _smsProcessor;
        private readonly IConfiguration _config;

        public WebhooksController(ILogger<WebhooksController> logger, IWalletService walletService, YaqeenPay.Application.Features.Wallets.Services.IBankSmsProcessingService smsProcessor, IConfiguration config)
        {
            _logger = logger;
