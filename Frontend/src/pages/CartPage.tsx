                ...
                <CardContent>
                  <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
                    ...
                    <CardMedia
                      ...
                      onClick={() => navigate(buildProductPath(item.productId, item.productName))}
                      onError={(e) => {
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      <Typography variant="h6" sx={{ mb: 1, cursor: 'pointer' }} onClick={() => navigate(buildProductPath(item.productId, item.productName))}>
                        {item.productName}
                      </Typography>
                      {item.sellerName && (
