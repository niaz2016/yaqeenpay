...
public class EmailService : IEmailService
{
    ...
    {
        var subject = "Reset Your YaqeenPay Password";
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>Hello {userName},</p>
            <p>We received a request to reset your password for your YaqeenPay account.</p>
            ...
            <p>Best regards,<br>The YaqeenPay Team</p>
        </div>
        <div class='footer'>
            <p>© 2025 YaqeenPay | Techtorio.online</p>
        ...
        var plainTextBody = $@"
YaqeenPay - Password Reset Request

Hello {userName},

We received a request to reset your password for your YaqeenPay account.
...
© 2025 YaqeenPay | Techtorio.online
...
";
    ...
    {
        var subject = "Verify Your YaqeenPay Email Address";
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>Hello {userName},</p>
            <p>Thank you for registering with YaqeenPay!</p>
...
Thank you for registering with YaqeenPay!
...
";
    ...
    {
        var subject = "Welcome to YaqeenPay!";
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>YaqeenPay is your trusted marketplace platform for secure transactions.</p>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>You can track your order status in your YaqeenPay dashboard.</p>
    ...
    {
        var subject = "Payment Received - YaqeenPay";
