...
public class ConfigurationUsageExample
{
    ...
    public async Task<JwtExampleConfig> GetJwtSettingsAsync()
    {
        ...
        {
            Issuer = await _configService.GetStringAsync("JwtSettings:Issuer", "YaqeenPay"),
            Audience = await _configService.GetStringAsync("JwtSettings:Audience", "YaqeenPayClient"),
