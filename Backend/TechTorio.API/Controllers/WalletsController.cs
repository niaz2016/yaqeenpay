...
using TechTorio.Application.Features.Wallets.Commands.CreateWallet;
using TechTorio.Application.Features.Wallets.Commands.TopUpWallet;
using TechTorio.Application.Features.Wallets.Queries.GetTopUpHistory;
using TechTorio.Application.Features.Wallets.Queries.GetTransactionHistory;
using TechTorio.Application.Features.Wallets.Queries.GetWalletBalance;
using TechTorio.Application.Features.Wallets.Queries.GetWalletSummary;
using TechTorio.Application.Features.Wallets.Queries.GetWalletAnalytics;
using TechTorio.Application.Features.Wallets.Queries.GetWalletTransactions;
using TechTorio.Application.Features.Wallets.DTOs;
    ...
    public async Task<IActionResult> UploadTopUpProof(Guid id)
        {
            ...
            var command = new TechTorio.Application.Features.Wallets.Commands.TopUpWallet.UploadTopUpProofCommand
            {
                TopUpId = id,
                FileName = safeName,
                FileUrl = fileUrl,
        ...
        public async Task<IActionResult> SubmitTopUpReference(Guid id, [FromBody] SubmitTopUpReferenceRequest request)
        {
            ...
            var cmd = new TechTorio.Application.Features.Wallets.Commands.TopUpWallet.SubmitTopUpReferenceCommand
            {
                TopUpId = id,
