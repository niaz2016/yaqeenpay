...
## Overview
This document explains the complete payment and escrow flow for orders in the TechTorio system. The flow is designed to protect both buyers and sellers by holding funds in escrow until delivery is confirmed.
...
- **Payment Handler**: `TechTorio.Application/Features/Orders/Commands/PayForOrder/PayForOrderCommand.cs`
- **Shipment Handler**: `TechTorio.Application/Features/Orders/Commands/MarkOrderAsShipped/MarkOrderAsShippedCommand.cs`
- **Delivery Confirmation Handler**: `TechTorio.Application/Features/Orders/Commands/ConfirmDelivery/ConfirmDeliveryCommand.cs`
- **Wallet Entity**: `TechTorio.Domain/Entities/Wallet.cs`
- **Order Entity**: `TechTorio.Domain/Entities/Order.cs`
