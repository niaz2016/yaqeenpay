...
namespace YaqeenPay.Application.Features.Authentication.Commands.ResendVerificationEmailByEmail;
...
public class ResendVerificationEmailByEmailCommandHandler : IRequestHandler<ResendVerificationEmailByEmailCommand, ApiResponse<bool>>
{
    ...
    public async Task<ApiResponse<bool>> Handle(ResendVerificationEmailByEmailCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var emailSubject = "YaqeenPay - Verification Link";
            var htmlBody = $@"
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class=""container"">
        ...
        <div class=""content"">
            ...
            <p>You requested a verification link for your YaqeenPay account. Click the button below to verify your email address:</p>
...
You requested a verification link for your YaqeenPay account. Click the link below to verify your email address:
