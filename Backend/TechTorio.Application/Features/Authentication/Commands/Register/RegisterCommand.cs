...
namespace TechTorio.Application.Features.Authentication.Commands.Register;
...
public class RegisterCommandHandler : IRequestHandler<RegisterCommand, ApiResponse<Guid>>
{
    ...
    public async Task<ApiResponse<Guid>> Handle(RegisterCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var emailSubject = "Verify Your TechTorio Account";
            ...
            var verificationLink = $"{frontendUrl}/techtorio/auth/verify-email?userId={result.UserId}&token={Uri.EscapeDataString(verificationToken)}";
...
<body>
    <div class=""container"">
        ...
        <div class=""content"">
            ...
            <p>Thank you for registering with TechTorio. To complete your registration and activate your account, please verify your email address by clicking the button below:</p>
            ...
            <div class=""warning"">
                <strong>Important:</strong> If you didn't create an account with TechTorio, please ignore this email. Your email address will not be used without verification.
            </div>
...
Thank you for registering with TechTorio. To complete your registration and activate your account, please verify your email address by clicking the link below:

{verificationLink}

This verification link will expire in 24 hours.

IMPORTANT: If you didn't create an account with TechTorio, please ignore this email. Your email address will not be used without verification.
