...
using TechTorio.Infrastructure.Persistence.Repositories;
using TechTorio.Infrastructure.Services;
using StackExchange.Redis;
using System.Security.Cryptography;
using TechTorio.Infrastructure.Services.Security;

namespace TechTorio.Infrastructure;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<TechTorio.Application.Features.Wallets.Services.IWalletTopupService, 
                          TechTorio.Application.Features.Wallets.Services.WalletTopupService>();
        services.AddScoped<TechTorio.Application.Features.Wallets.Services.IQrCodeService, 
                          TechTorio.Application.Features.Wallets.Services.QrCodeService>();
    services.AddScoped<TechTorio.Application.Features.Wallets.Services.IBankSmsProcessingService,
              TechTorio.Application.Features.Wallets.Services.BankSmsProcessingService>();
        
        // Register background service for cleanup
        services.AddHostedService<TechTorio.Infrastructure.Services.TopupLockCleanupService>();
